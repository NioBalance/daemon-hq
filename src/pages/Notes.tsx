    ...
    <>
      ...
      {!isLoading && !isError && (
        <>
          ...
          {all.length === 0 && <EmptyState icon="note" title="Bacheca vuota" caption="Scrivi la prima nota del team." ctaLabel="Scrivi una nota" onCta={() => document.getElementById('memo-new-testo')?.focus()} />}
        </>
      )}
