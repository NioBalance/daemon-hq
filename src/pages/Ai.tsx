    ...
    <>
      ...
      {!isLoading && !isError && (
        <>
          ...
          {(links ?? []).length === 0 && <EmptyState icon="star" title="Nessuno strumento collegato" caption="Collega i tool AI che il team usa davvero." ctaLabel="+ Strumento" onCta={openCreate} />}
        </>
      )}
